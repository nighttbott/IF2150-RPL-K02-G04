...
| C | Mengubah istilah programmer menjadi administrator. |
...
| US-07 | Administrator | Memantau server dan fitur fiturnya | Memastikan materi yang disajikan lengkap dan mudah dipahami alurnya.|
...
| A06 | Memelihara Aplkasi | Administrator memantau server supaya tidak ada kendala. | US-07 |
...
| R15 | A06 | User | Dalam interval waktu yang rutin, administrator harus melakukan pemeliharaan aplikasi dengan memantau server supaya tidak ada kendala | Ya |
...
# Referensi
- Slides IF2150 Sesi 4 — Perumusan Kebutuhan
